...
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/cane.OBJ',
    (object) => {
        ...
        object.position.set(0.2, -0.35, -0.35);
...
// NEW: Export function that displays Cane's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Cane ===');
    ...
    icon.src = 'imgs/voidwalker-icons/cane.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #00b7eb'; // Cane's color
    ...
    console.log('✓ Cane character icon and name added to screen');
