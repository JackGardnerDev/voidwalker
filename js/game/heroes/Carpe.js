...
// Create Carpe's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/carpe.obj',
    (object) => {
        ...
        object.position.set(0.2, -0.35, -0.5);
        ...
        const scaleFactor = 0.001; // Defined once for clarity
...
// NEW: Export function that displays Carpe's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Carpe ===');
    ...
    icon.src = 'imgs/voidwalker-icons/carpe.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #b90202'; // Carpe's color
    ...
    console.log('✓ Carpe character icon and name added to screen');
