...
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/danteh.obj',
    (object) => {
        ...
        object.position.set(0.25, -0.35, -0.1);
...
// NEW: Export function that displays Danteh's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Danteh ===');
    ...
    icon.src = 'imgs/voidwalker-icons/danteh.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #7030A0'; // Danteh's color
    ...
    console.log('✓ Danteh character icon and name added to screen');
