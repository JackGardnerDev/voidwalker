...
// Create IM-94's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/im-94.obj',
    (object) => {
        ...
        object.position.set(0.2, -2.0, -0.2);
        // FIX: Rotation set to orient the gun correctly. 
        // X (Pitch), Y (Yaw), Z (Roll)
        object.rotation.set(0, Math.PI, 0);
        // object.rotation.set(0, 0, 0);

        const scaleFactor = 0.2; // Defined once for clarity
...
// NEW: Export function that displays IM-94's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for IM-94 ===');
    ...
    icon.src = 'imgs/voidwalker-icons/im-94.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #66FF66'; // IM-94's color
    ...
    console.log('✓ IM-94 character icon and name added to screen');
