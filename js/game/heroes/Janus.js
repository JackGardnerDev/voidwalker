...
// Create Janus's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/janus.obj',
    (object) => {
        ...
        object.position.set(0.0, -0.615, -0.275);
        // FIX: Rotation set to orient the gun correctly. 
        // X (Pitch), Y (Yaw), Z (Roll)
        object.rotation.set(Math.PI / 5, Math.PI + Math.PI / 4, 0);
...
// NEW: Export function that displays Janus's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Janus ===');
    ...
    icon.src = 'imgs/voidwalker-icons/janus.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #FF3300'; // Janus's color
    ...
    console.log('✓ Janus character icon and name added to screen');
