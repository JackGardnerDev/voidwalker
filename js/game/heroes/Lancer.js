...
// Create Lancer's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/lancer.obj',
    (object) => {
        ...
        object.position.set(1.0, -1.0, 12.5);
        // FIX: Rotation set to orient the gun correctly. 
        // We'll use the Y-axis flip to correct the model's direction while keeping the X-axis for laying it down.
        object.rotation.set(0, Math.PI, 0);
        // object.rotation.set(0, 0, 0);

        const scaleFactor = 0.01; // Defined once for clarity
...
// NEW: Export function that displays Lancer's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Lancer ===');
    ...
    icon.src = 'imgs/voidwalker-icons/lancer.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #0000cd'; // Lancer's color
    ...
    console.log('✓ Lancer character icon and name added to screen');
