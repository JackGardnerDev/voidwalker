...
// Create Mae's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    (object) => {
        ...
        object.position.set(1, -2.25, -1.75);
...
// NEW: Export function that displays Mae's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Mae ===');
    ...
    icon.src = 'imgs/voidwalker-icons/mae.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #FF3399'; // Mae's color
    ...
    console.log('✓ Mae character icon and name added to screen');
