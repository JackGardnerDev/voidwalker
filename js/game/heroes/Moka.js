...
// Create Moka's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/moka.obj',
    (object) => {
        ...
        object.position.set(0.2, -0.80, -0.4);
        ...
        const scaleFactor = 0.1; // Defined once for clarity
...
// NEW: Export function that displays Moka's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Moka ===');
    ...
    icon.src = 'imgs/voidwalker-icons/moka.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #00B050'; // Moka's color
    ...
    console.log('✓ Moka character icon and name added to screen');
