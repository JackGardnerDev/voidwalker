...
// Create Nyx's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    (object) => {
        ...
        object.position.set(0.35, -0.525, -0.2);
        // FIX: Rotation set to orient the gun correctly. 
        object.rotation.set(0, Math.PI + Math.PI / 2, 0);
...
// NEW: Export function that displays Nyx's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Nyx ===');
    ...
    icon.src = 'imgs/voidwalker-icons/nyx.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #FFFF00'; // Nyx's color
    ...
    console.log('✓ Nyx character icon and name added to screen');
