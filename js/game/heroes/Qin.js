...
// Create Qin's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    (object) => {
        ...
        object.position.set(0.2, -0.4, -0.2);
        ...
        const scaleFactor = 1.25; // Defined once for clarity
...
// NEW: Export function that displays Qin's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Qin ===');
    ...
    icon.src = 'imgs/voidwalker-icons/qin.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #660033'; // Qin's color
    ...
    console.log('✓ Qin character icon and name added to screen');
