...
// Create Raze's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    loader.load(
    'assets/models/weapons/raze.obj',
    (object) => {
        ...
        object.position.set(0.75, -0.35, -0.1);
        ...
        const scaleFactor = 1.0; // Defined once for clarity
...
// NEW: Export function that displays Raze's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Raze ===');
    ...
    icon.src = 'imgs/voidwalker-icons/raze.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #CC00FF'; // Raze's color
    ...
    console.log('✓ Raze character icon and name added to screen');
