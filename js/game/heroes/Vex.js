...
// Create Vex's unique weapon - Loads OBJ with fallback
export function createWeapon() {
    ...
    (object) => {
        ...
        object.position.set(0.2, -0.2, -0.3);
        ...
        const scaleFactor = 0.004; // Defined once for clarity
...
// NEW: Export function that displays Vex's icon
export function showCharacterIcon() {
    console.log('=== showCharacterIcon called for Vex ===');
    ...
    icon.src = 'imgs/voidwalker-icons/vex.png';
    icon.alt = 'Cane';
    icon.style.width = '80px';
    icon.style.height = '80px';
    icon.style.border = '3px solid #FFCC00'; // Vex's color
    ...
    console.log('✓ Vex character icon and name added to screen');
